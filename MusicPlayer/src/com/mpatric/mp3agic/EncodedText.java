...
public class EncodedText {
	...
	public EncodedText(String string, byte transcodeToTextEncoding) throws IllegalArgumentException, UnsupportedEncodingException {
		this(string);
	...
	public void setTextEncoding(byte textEncoding) throws UnsupportedEncodingException {
		setTextEncoding(textEncoding, true);
	}
	
	public void setTextEncoding(byte textEncoding, boolean transcode) throws UnsupportedEncodingException {
		if (this.textEncoding != textEncoding) {
                        String s = bytesToString(this.value, characterSetForTextEncoding(this.textEncoding));
			this.textEncoding = textEncoding;
			this.value = s.getBytes(characterSetForTextEncoding(textEncoding));
		}
	}
	...
	private static String bytesToString(byte[] bytes, String characterSet) throws UnsupportedEncodingException {
                return new String(bytes, characterSet);
	}
	
	private static byte[] stringToBytes(String s, String characterSet) {
		try {
			return s.getBytes(characterSet);
		} catch (UnsupportedEncodingException e) {
			return null;
		}
	}
